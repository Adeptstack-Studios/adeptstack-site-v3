    ...
    return (
      ...
      `}</style>
            ...
            <div className="absolute inset-0 w-full h-full bg-slate-950">
                ...
                <div className="absolute top-10 right-0 w-125 h-125 bg-blue-600 rounded-full mix-blend-screen filter blur-[100px] opacity-20 animate-blob animation-delay-2000"></div>
