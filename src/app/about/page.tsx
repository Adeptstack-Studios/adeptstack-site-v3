                ...
                <section className="grid md:grid-cols-2 gap-16 items-start mb-32">
                    ...
                    <div className="relative border-l-2 border-slate-800 ml-3 space-y-16 pl-8 py-2">
                        ...
                        <div className="relative group">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">
                                To bring structure to the growing portfolio, everything was renamed <strong>Adeptstack</strong>.
                                ProgrammerLP was the coder and Adeptstack became the label for the products.
                            </p>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">
                                Adeptstack is growing up. With our new logo, modern website, and refined profile, we now have a more professional appearance without losing the charm of indie development.
                            </p>
                        </div>
